...
public class FXMakerMain : MonoBehaviour
{
	...
	// directroy
    private string igsorf_resourcesdir = "Assets/Plugins/IGSoft_Resources";

    public string m_IGSoft_ResourcesDir
    {
        get
        {
            return igsorf_resourcesdir;
        }
        set
        {
            if (value != igsorf_resourcesdir)
                igsorf_resourcesdir = value;
        }
    }
	...
	protected	string					m_ProjectsDir				= "Assets/Resources/IGSoft_Projects";
	...
	public string GetResourceDir(TOOLDIR_TYPE tooldirType)
	{
		...
		switch (tooldirType)
		{
            ...
            case TOOLDIR_TYPE.PROJECTS: return m_ProjectsDir;//subDir = m_ProjectsDir;					break;
